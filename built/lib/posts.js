"use strict";
// get all the post data from posts
...
function getSortedPostsData() {
    ...
    var allPostsData = fileNames.map(function (fileName) {
        ...
        var matterResult = (0, gray_matter_1.default)(fileContents);
...
function getPostData(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fullPath = path_1.default.join(postsDirectory, "".concat(id, ".md"));
                    fileContents = fs_1.default.readFileSync(fullPath, 'utf8');
                    matterResult = (0, gray_matter_1.default)(fileContents);
                    return [4 /*yield*/, (0, remark_1.remark)()
                ...
                case 1:
                    ...
                    // Combine the data with the id
                    return [2 /*return*/, __assign({ id: id, contentHtml: contentHtml }, matterResult.data)];
            }
        });
    });
}
